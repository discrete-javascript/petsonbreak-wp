...
echo'	<div class="mo_registration_support_layout">
			<h3>'.__("Support",MoConstants::TEXT_DOMAIN).'</h3>
			<p>'.__("Need any help? Just send us a query so we can help you.",MoConstants::TEXT_DOMAIN).'</p>
					...
					<table class="mo_registration_settings_table">
						<tr><td>
							<input type="email" class="mo_registration_table_textbox" id="query_email" name="query_email" value="'.$email.'" 
								placeholder="'.__("Enter your Email",MoConstants::TEXT_DOMAIN).'" required />
							</td>
						</tr>
						<tr><td>
							<input type="text" class="mo_registration_table_textbox" name="query_phone" id="query_phone" value="'.$phone.'" 
								placeholder="'.__("Enter your phone",MoConstants::TEXT_DOMAIN).'"/>
							</td>
						</tr>
						<tr>
							<td>
								<textarea id="query" name="query" class="mo_registration_settings_textarea" style="resize: vertical;width:100%" 
									...
									placeholder="'.__("Write your query here",MoConstants::TEXT_DOMAIN).'"></textarea>
							</td>
						</tr>
					</table>
					<input type="submit" name="send_query" id="send_query" value="'.__("Submit Query",MoConstants::TEXT_DOMAIN).'" 
