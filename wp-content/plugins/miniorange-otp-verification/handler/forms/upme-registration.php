<?php
	...
	class UserProfileMadeEasyRegistrationForm extends FormInterface
	{
		...
		function handleForm()
		{
			$this->otpType = get_option('mo_customer_validation_upme_enable_type');
			$this->phoneKey = get_option('mo_customer_validation_upme_phone_key');
		...
		function handle_failed_verification($user_login,$user_email,$phone_number)
		{
			...
			$otpVerType = strcasecmp($this->otpType,"mo_upme_phone_enable")==0 ? "phone" 
							: (strcasecmp($this->otpType,"mo_upme_both_enable")==0 ? "both" : "email" );
		...
		function handle_post_verification($redirect_to,$user_login,$user_email,$password,$phone_number,$extra_data)
		{
	 	...
	 	{
	 		if(strcasecmp($this->otpType,"mo_upme_phone_enable")==0)
				miniorange_site_challenge_otp($user_name,$user_email,null,$phone_number,"phone");
			else if(strcasecmp($this->otpType,"mo_upme_both_enable")==0)
