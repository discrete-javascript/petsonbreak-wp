<?php
	...
	class WooCommerceSocialLoginForm extends FormInterface
	{
		...
		{
			mo_external_phone_validation_form(	MoUtility::currentPageUrl(),$usermeta['user_email'],MoMessages::showMessage('PHONE_VALIDATION_MSG'),
												'WC_SOCIAL',$usermeta);
		}
		...
		{
			MoUtility::checkSession();
			if(!isset($_SESSION[$this->formSessionVar])) return TRUE;
			return FALSE;
		}
		...
		function handleFormOptions()
		{
			...
			update_option('mo_customer_validation_wc_social_login_enable',
