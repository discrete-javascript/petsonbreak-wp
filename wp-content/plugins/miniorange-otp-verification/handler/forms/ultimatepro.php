<?php
	...
	class UltimateProRegistrationForm extends FormInterface
	{
		...
		function handleForm()
		{	
			$this->otpType = get_option('mo_customer_validation_ultipro_type');
			...
			if(strcasecmp($this->otpType,"mo_ultipro_phone_enable")==0)
				add_shortcode('mo_phone', array($this,'_phone_shortcode'));
			if(strcasecmp($this->otpType,"mo_ultipro_email_enable")==0)
		...
		{
			return get_option('mo_customer_validation_ultipro_enable') ? true : false;
		}
		...
		function handleFormOptions()
	    {
			...
			update_option('mo_customer_validation_ultipro_enable',
				isset( $_POST['mo_customer_validation_ultipro_enable']) ? $_POST['mo_customer_validation_ultipro_enable'] : 0);
			update_option('mo_customer_validation_ultipro_type',
