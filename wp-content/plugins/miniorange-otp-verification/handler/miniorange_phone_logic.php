...
class PhoneLogic extends LogicInterface
{
	...
	{
		return get_option("mo_otp_success_phone_message") ? get_option('mo_otp_success_phone_message') : MoMessages::showMessage('OTP_SENT_PHONE');
	}

	public function _get_otp_sent_failed_message()
	{
		return get_option("mo_otp_error_phone_message") ? get_option('mo_otp_error_phone_message') : MoMessages::showMessage('ERROR_OTP_PHONE');
	}

	public function _get_otp_invalid_format_message()
	{
		return get_option("mo_otp_invalid_phone_message") ? get_option('mo_otp_invalid_phone_message') : MoMessages::showMessage('ERROR_PHONE_FORMAT');
	}
	...
	{
		return get_option("mo_otp_blocked_phone_message") ? get_option('mo_otp_blocked_phone_message') : MoMessages::showMessage('ERROR_PHONE_BLOCKED');
	}
}