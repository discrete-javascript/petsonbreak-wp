...
class mk_adivaha_custom_menu {
    ...
    function __construct() {
        ...
        add_filter( 'wp_setup_nav_menu_item', array( $this, 'mk_adivaha_add_custom_nav_fields' ) );

        // save menu custom fields
        add_action( 'wp_update_nav_menu_item', array( $this, 'mk_adivaha_update_custom_nav_fields'), 10, 3 );
        
        // edit menu walker
        add_filter( 'wp_edit_nav_menu_walker', array( $this, 'mk_adivaha_edit_walker'), 10, 2 );
     ...
     * @return      void
    */
    function mk_adivaha_add_custom_nav_fields( $menu_item ) {
     ...
     * @return      void
    */
    function mk_adivaha_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
     ...
     * @return      void
    */
    function mk_adivaha_edit_walker($walker,$menu_id) {
...
$GLOBALS['adivaha_custom_menu'] = new mk_adivaha_custom_menu();
 ...
 * @return      void
*/
class mk_adivaha_walker extends Walker_Nav_Menu {
    /**
         * @var int $columns 
         */
        var $columns = 0;
