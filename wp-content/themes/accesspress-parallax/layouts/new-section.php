...
.news-section-body h3{font-size: 20px;color: #555;}
.news-section-body h3 a{font-size: 16px;color: #333;}
.news{background: #fff;padding: 2px;border-bottom:1px solid #ccc;color:#000;}
.news p{ padding-left:18px;line-height: 18px;}
.pet_house2 {}
...
#home-review-section .parlorem{padding-bottom:15px;}
	...
	#home-review-section .sec2-rating .rat{line-height:25px;float:left;}
	...
	#home-review-section .sec2-rating .sec2-rating-top{padding-bottom:2px;margin-top:-15px;}
      ...
      <?php $results =$wpdb->get_results("select * from twc_news where published='Yes' and status_deleted=0");
       ...
       <li>
	     <div class="news">
			 ...
			 <p style="margin-top:-10px !important;margin-bottom:-13px !important;"><?php echo stripcslashes(substr($obj->description,0,148));?></p>
		   </div>
	   </li>
       <?php } ?>
      </ul>
...
<h2 style="font-size: 20px;padding: 10px;color: #fff;background: #E66432;font-weight: 500;border:1px solid #736E7El;margin-top:-5px;">REVIEWS</h2>
<div class="detail-section2" style="margin-top:-50px;">
   ...
   <div class="dynamic_width_div">
	...
	$averageFeedback =ceil($rating5/$feedbackResult->totalfeedback);
		  ...
		  ?>
   		...
   		<div class="detail-section2-cols row">
			<div class="col-md-3 col-sm-3 col-xs-3 det-rat-smry" style="float:left;">
					<div class="det-sec2-col sec2-rating" style="height:290px !important;">
		...
		<div class="services_slider" id="review_item">
...
.carousel-reviews .bx-prev{
display:none !important;
}


.carousel-reviews .bx-next{
display:none !important;
}
</style>
<script>
