	 ...
	 <div class="pet-banner1 bg_white" style="position: relative; overflow: visible; box-sizing: border-box; min-height: 1px;" id="sidebar"> 
		<div style="padding-top: 0px; padding-bottom: 1px; position: static;" class="theiaStickySidebar">
	       <div class="view-banner" ui-view="banner" style="position:relative;">
			 	<div class="fakeDiv" style="position: absolute;
    height: 800px;
			   ...
			   <div id="exTab1" >
					<div class="div_clol-notuse pet-divclol">
					     <ul  class="nav nav-pills">
							<li class="tabbss tab_1 active" ng-click="selectType(1);"><a  href="#home/?tab=hotel" data-toggle="tab" title="Hotel" ALT="Hotel"  return false;><i class="fa fa-bed" ></i><span><?php echo $mk_options['tab_hotel'];?></span></a></li>
							<li class="tabbss tab_0"><a ng-click="selectType(0);" href="#home/?tab=flight" data-toggle="tab" title="Flight" ALT="Flight"><i class="fa fa-plane"></i><span><?php echo $mk_options['tab_flight'];?></span></a></li>
							<li class="tabbss tab_4" ng-click="selectType(4);"><a href="#home/?tab=holiday" data-toggle="tab" title="Vacation" ALT="Vacation"><i class="fa fa-umbrella"></i><span><?php echo $mk_options['tab_holiday'];?></span></a></li>
							<li class="tabbss tab_3" ng-click="selectType(3)"><a href="#home/?tab=resort" data-toggle="tab" title="Resort" ALT="Resort"><i class="fa fa-home"></i><span><span><?php echo $mk_options['tab_resort'];?></span></a></li>
							<li class="tabbss tab_5" ng-click="selectType(5)"><a href="#home/?tab=bedbreakfast" data-toggle="tab" title="Bed & Breakfast" ALT="Bed & Breakfast"><i class="fa fa-coffee"></i><span><?php echo $mk_options['tab_bedbreakfast'];?></span></a></li>
						  </ul>
