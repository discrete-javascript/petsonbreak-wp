...
function register_testimonials_post_type() {
	...
	register_post_type( 'testimonial', array(
			'labels' => array(
				'name' => __( 'Testimonials', 'mk_framework' ), __( 'post type general name', 'mk_framework' ),
				'singular_name' => __( 'Testimonial', 'mk_framework' ), __( 'post type singular name', 'mk_framework' ),
				'add_new' => __( 'Add New Testimonial', 'mk_framework' ), __( 'Testimonials', 'mk_framework' ),
