...
function register_edge_slider_post_type(){
	...
	global $mk_options;
   		if($mk_options['edge-post-type'] == 'false') return false;

	
	register_post_type('edge', array(
		'labels' => array(
			'name' => __('Edge Slideshow','mk_framework'), __('post type general name','mk_framework'),
			'singular_name' => __('Edge Item','mk_framework'), __('post type singular name','mk_framework'),
			'add_new' => __('Add New Edge Slider','mk_framework'), __('slideshow','mk_framework'),
