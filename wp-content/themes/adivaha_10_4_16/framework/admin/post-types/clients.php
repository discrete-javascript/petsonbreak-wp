...
function register_clients_post_type(){
	...
	global $mk_options;
   		if($mk_options['clients-post-type'] == 'false') return false;

	register_post_type('clients', array(
		'labels' => array(
			'name' => __('Clients','mk_framework'), __('post type general name','mk_framework'),
			'singular_name' => __('Client','mk_framework'), __('post type singular name','mk_framework'),
			'add_new' => __('Add New Client','mk_framework'), __('clients','mk_framework'),
