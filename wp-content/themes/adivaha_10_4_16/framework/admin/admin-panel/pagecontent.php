 ...
 array(
  ...
  array(
   ...
   array(
	...
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("Manage My Booking", "mk_framework"),
        "id" => "manage_my_booking",
	...
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("Pet Services", "mk_framework"),
        "id" => "pet_services",
        "default" => 'Pet Services',
        "type" => "text"
    ),
	
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("This image will be used as for choose pet section.", "mk_framework"),
        "id" => "pet-choose",
        "default" => "",
        "type" => "upload"
    ),
	...
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("This image will be used as for choose pet section content.", "mk_framework"),
        "id" => "pet-choose-text",
        "default" => "Choose Your Pet Service",
        "type" => "text"
    ),
	
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("The affection and care showered by you on your loved pet is irreplaceable, for every other need of your pet we have one or the other services to offer. We also assist you to ensure general well-being of your beguiling companion.", "mk_framework"),
        "id" => "affection_and_care_showered_by_you_on_your_loved_pet",
        "default" => 'The affection and care showered by you on your loved pet is irreplaceable, for every other need of your pet we have one or the other services to offer. We also assist you to ensure general well-being of your beguiling companion.',
        "type" => "textarea"
    ),
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("View all", "mk_framework"),
        "id" => "view_all",
        "default" => 'View all',
        "type" => "text"
    ),
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("How do we do what’s best for our pet(s)?", "mk_framework"),
        "id" => "container_for_content1",
        "default" => 'How do we do what’s best for our pet(s)?',
        "type" => "text"
    ),
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("Are you a new pet parent, or looking for answers to a pet-related question? This is the section you will fall in love with. Here you can arm yourself with the knowledge to give your pet a happier life style, and bring you more joy than you ever imagined. Also, as responsible pet parents, we have an obligation to care for our furry friends in sickness and in health. But as pet care costs rise, we will remain committed to providing pet owners with the information you need to select the best possible pet-care option for your pets.", "mk_framework"),
        "id" => "container_for_content1_description",
        "default" => 'Are you a new pet parent, or looking for answers to a pet-related question? This is the section you will fall in love with. Here you can arm yourself with the knowledge to give your pet a happier life style, and bring you more joy than you ever imagined. Also, as responsible pet parents, we have an obligation to care for our furry friends in sickness and in health. But as pet care costs rise, we will remain committed to providing pet owners with the information you need to select the best possible pet-care option for your pets.',
        "type" => "textarea"
    ),
	
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("You might be Interested in exploring these Pet Services ", "mk_framework"),
        "id" => "container_for_content2",
        "default" => 'You might be Interested in exploring these Pet Services ',
        "type" => "text"
    ),
	...
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("Are you a new pet parent, or looking for answers to a pet-related question? This is the section you will fall in love with. Here you can arm yourself with the knowledge to give your pet a happier life style, and bring you more joy than you ever imagined. Also, as responsible pet parents, we have an obligation to care for our furry friends in sickness and in health. But as pet care costs rise, we will remain committed to providing pet owners with the information you need to select the best possible pet-care option for your pets.", "mk_framework"),
        "id" => "container_for_content2_description",
        "default" => 'Are you a new pet parent, or looking for answers to a pet-related question? This is the section you will fall in love with. Here you can arm yourself with the knowledge to give your pet a happier life style, and bring you more joy than you ever imagined. Also, as responsible pet parents, we have an obligation to care for our furry friends in sickness and in health. But as pet care costs rise, we will remain committed to providing pet owners with the information you need to select the best possible pet-care option for your pets.',
        "type" => "textarea"
    ),
	...
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("Are you a new pet parent, or looking for answers to a pet-related question? This is the section you will fall in love with.", "mk_framework"),
        "id" => "container_for_content3_description",
        "default" => 'Are you a new pet parent, or looking for answers to a pet-related question? This is the section you will fall in love with. Here you can arm yourself with the knowledge to give your pet a happier life style, and bring you more joy than you ever imagined.',
        "type" => "textarea"
    ),
	
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("Find Best Deals", "mk_framework"),
        "id" => "find_best_deals",
        "default" => 'Find Best Deals',
        "type" => "text"
    ),
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("Latest News", "mk_framework"),
        "id" => "latest_news",
        "default" => 'Latest News',
        "type" => "text"
    ),
   ...
   array(
	...
	array(
        "name" => __("Blog Section", "mk_framework"),
        "desc" => __("Blog Title", "mk_framework"),
        "id" => "blog_title",
        "default" => 'Our Blog',
        "type" => "text"
    ),
	array(
        "name" => __("", "mk_framework"),
        "desc" => __("Blog Description", "mk_framework"),
        "id" => "blog_description",
        "default" => 'Planning to develop Hotel Directory Site? Get your own site quickly in few easy steps. Install, Enter API Key Credentials, 100% Customizable, Easy and Fast Approval and 24/7 Customer Support. We help you with all',
        "type" => "text"
    ),
