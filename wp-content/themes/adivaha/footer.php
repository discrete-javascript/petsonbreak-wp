        ...
        <div class="col-md-12">
          <div class="col-md-4">
			<div class="footer_colm">
              <h1 class="foot-colHead">POPULAR SERVICES</h1>
	  ...
	  <div class="row">
	    <div class="col-md-12">
		    ...
		    <ul class="footer_links ausAd">
				<li><span><i class="fa fa-home"></i></span><a><?php echo $mk_options['f_address'];?></a></li>
                <li><span><i class="fa fa-envelope"></i></span><a>info[at]petsonbreak[dot]com</a></li>
			...
			<div class="col-md-4">
			  ...
			  <ul class="footer_links indAdd">
               ...
               <li><span><i class="fa fa-phone"></i></span><a>+91 7566485676 (Pet Related)</a></li>
				<li><span><i class="fa fa-phone"></i></span><a><?php echo $mk_options['f_contact_number'];?></a></li>
			   <?php } if($mk_options['f_email']!=''){?>
                <li><span><i class="fa fa-envelope"></i></span><a><?php echo $mk_options['f_email'];?></a></li>
			   <?php } if($mk_options['f_website']!=''){?>
                <li><span><i class="fa fa-globe"></i></span><a><?php echo $mk_options['f_website'];?></a></li>
			   <?php } if($mk_options['f_skype']!=''){?>
                <li><span><i class="fa fa-envelope"></i></span><a><?php echo $mk_options['f_skype'];?></a></li>
			   <?php }?>
			...
			<div class="col-md-4">
			  <div class="footer_colm">
			   ...
			   <h6 style="color:#FFF">AUSTRALIA</h6>
                ...
                <li><span><i class="fa fa-home"></i></span><a>43 Whites Lane,Glen Waverley 3150,Victoria  Australia</a></li>
                <li><span><i class="fa fa-phone"></i></span><a >0421 3766 36 (Travel Related)</a></li>
                <li><span><i class="fa fa-envelope"></i></span><a >australiaincoming[at]petsonbreak[dot]com</a></li>
...
<div class="popupbox-container_new" id="booking_cancellation">
   <div class="feedback-div">
   <div class="feedback-div-container">
    <form name="bookingCancellationFrm" id="bookingCancellationFrm">
	   <input type="hidden" name="itineraryId" id="itineraryId" value="">
	   <input type="hidden" name="confirmationNumber" id="confirmationNumber" value="">
	   <input type="hidden" name="bc_email" id="bc_email" value="">
       <div class="panel panel-default">
          <div class="panel-heading feed-head"><img src="<?php echo get_template_directory_uri();?>/images/logo_pet.png"></div>
          <div class="panel-body">
		   <div class="feed-stg1" id="cancelMsg">
			<p>ItineraryId: <span id="itineraryId_txt"></span></p>
			<p>confirmationNumber: <span id="confirmationNumber_txt"></span> </p>
			<p>Email: <span id="bc_email_txt"></span> </p>
			
			<p><select name="reason" id="reason">
            ...
            <div class="panel-footer feed-boot">
				<div class="snd_feed">
				<span class="bookingCancelBtn"><a href="javascript:void(0);" style="color:#e74c3c;">Cancel Now</a></span>
				 <span class="close_feed">Close</span>
				</div>
			</div>	
...
<!-- Already register -->
<div class="popupbox-container_new" id="already_registered">
   <div class="feedback-div">
   <div class="feedback-div-container">
        <div class="panel panel-default">
          <div class="panel-heading feed-head"><img src="<?php echo get_template_directory_uri();?>/images/logo_pet.png"></div>
          <div class="panel-body">
		    <div class="feed-stg1">
			 <p>This Email id is already exist, Please try another email id </p>
			 <p style="padding-left:112px"><b>OR</b></p>
			 <p>Click here to get you password <a href="<?php echo site_url();?>/forgot-password/">Get Password</a></p>
			</div>
            <div class="panel-footer feed-boot">
				<div class="snd_feed">
				 <span class="close_feed">Close</span>
          ...
          <div class="panel-body">
            <form name="sendqueryFrm" id="sendqueryFrm">
              ...
              <div class="feed-stg1">
				...
				$phone =get_user_meta($_SESSION['userID'], $key = 'phone', $single = false); 
					...
					<input type="hidden" id="feedtype" name="feedtype" value="Reviews">
                     <div class="feed_cmnt_bot">
					    ...
					    <div class="quer_fName">
						  <h4>First Name</h4>
						  <input type="text" name="first_name" id="first_name" placeholder="First Name" value="<?php echo $cUser->user_firstname ;?>">
						</div>
						
					    <div class="quer_fLast">
						  <h4>Last Name</h4>
						  <input type="text" name="last_name" id="last_name" placeholder="Last Name" value="<?php echo $cUser->user_lastname ;?>">
						</div>
						
						<div class="quer_Email">
						  <h4>Email</h4>
						  <input type="text" name="email"  placeholder="Email" value="<?php echo $cUser->user_email;?>">
						</div>
						
						<div class="quer_Contact">
						  <h4>Phone</h4>
						  <input type="text" name="contact_number" placeholder="Contact Number" value="<?php echo $phone[0];?>">
						</div>
            ...
            <div class="snd_feed">
              <!--  <span><a href="#" id="FeedbackBtn" class="snd_feed_btn">Send Feedback</a></span>-->
				...
				<span><input type="submit" id="queryBtn1" value="Send Enquiry" class="queryBtns"></span>
...
<div class="share-btn">
  <span class="st_facebook_large all_share_btn" st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>'></span>
  <span class="st_twitter_large all_share_btn" st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>' ></span>
  <span class="st_linkedin_large all_share_btn" st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>'></span>
  <span class="st_sharethis_large" st_title='<?php the_title(); ?>' st_url='<?php the_permalink(); ?>'></span>
</div>
<!-- Share this -->
<!--
<script charset="utf-8" type="text/javascript">var switchTo5x=true;</script>
<script charset="utf-8" type="text/javascript" id="st_insights_js" src="http://w.sharethis.com/button/buttons.js?publisher=wp.c24de8dd-2097-4d76-b58a-11b83c1ab461&product=sharethis-wordpress"></script>
<script charset="utf-8" type="text/javascript">stLight.options({"publisher":"wp.c24de8dd-2097-4d76-b58a-11b83c1ab461"});var st_type="wordpress4.7.4";</script>
-->
...
$(".share-btn, .all_share_btn").mouseover(function(){
        $(".all_share_btn").show();
    });
...
<script>
function BookingCancel(itineraryId,confirmationNumbers,user_email){
	$('#itineraryId').val(itineraryId);
	$('#confirmationNumber').val(confirmationNumbers);
	$('#bc_email').val(user_email);
	
	$('#itineraryId_txt').html(itineraryId);
	$('#confirmationNumber_txt').html(confirmationNumbers);
	$('#bc_email_txt').html(user_email);
	
	$('#booking_cancellation').show();
}

$('.bookingCancelBtn').click(function(){
	var frmData2 =$("#bookingCancellationFrm" ).serialize();
	
	$.ajax({
		 type: "GET",
		 url: "<?php echo get_template_directory_uri(); ?>/api/update_rates.php",
		 data: "action=BookingCancellation&"+frmData2,
		 success: function(Data){
			if(Data==1){
				$('#cancelMsg').html('<span style="color:#59c45a;">Booking Cancellation Request Successfull</span>');
				setTimeout(function(){
				   window.location.reload(1);
				}, 1000);
			}
			else{
				$('#cancelMsg').html('<span style="color:#59c45a;">Request Failed</span>');
			}
		 }
	})
})
...
#st-2 .st-total{    min-height: 48px !important;}

.popupbox-container_new {
    position: fixed;
    left: 0px;
    right: 0px;
    width: 100%;
