...
$our_expertise_data =$results->our_expertise_data;
$ourDataObj =json_decode(preg_replace('/[\x00-\x1F\x80-\xFF]/', '', $our_expertise_data));
...
<div class="Expertise_Data" id="dog_supplier" >
  <div class="Expertise_Data_Scroll">
   ...
   <?php foreach($dog_supplies_arr as $val){
	      if(in_array($val,$ourDataObj->dog)){$dselected ='checked="checked"';}
		  else{$dselected='';}
	    echo '<div class="srv-off-chk"><label><input type="checkbox" name="our_expertise_data[dog][]" value="'.$val.'" '.$dselected.'><span class="srv-off-title">'.$val.'</span></label></div>'; 
      }?>
   </div>
</div>
...
<div class="Expertise_Data" id="cat_supplier">
   ...
   <?php foreach($cat_supplies_arr as $val){
	     if(in_array($val,$ourDataObj->cat)){$cselected ='checked="checked"';}
		  else{$cselected='';}
	    echo '<div class="srv-off-chk"><label><input type="checkbox" name="our_expertise_data[cat][]" value="'.$val.'" '.$cselected.'><span class="srv-off-title">'.$val.'</span></label></div>'; 
      }?>
	</div>
</div>
...
<div class="Expertise_Data" id="fish_supplier">
   ...
   <?php foreach($fish_supplies_arr as $val){
	    if(in_array($val,$ourDataObj->fish)){$fselected ='checked="checked"';}
		  else{$fselected='';}
	    echo '<div class="srv-off-chk"><label><input type="checkbox" name="our_expertise_data[fish][]" value="'.$val.'" '.$fselected.'><span class="srv-off-title">'.$val.'</span></label></div>'; 
      }?>
	</div>
</div>
...
<div class="Expertise_Data" id="bird_supplier">
   ...
   <?php foreach($bird_supplies_arr as $val){
	     if(in_array($val,$ourDataObj->bird)){$bselected ='checked="checked"';}
		  else{$bselected='';}
	    echo '<div class="srv-off-chk"><label><input type="checkbox" name="our_expertise_data[bird][]" value="'.$val.'" '.$bselected.'><span class="srv-off-title">'.$val.'</span></label></div>'; 
      }?>
	</div>
</div>
...
<div class="Expertise_Data" id="small_supplier">
    ...
    <?php foreach($small_supplies_arr as $val){
		  if(in_array($val,$ourDataObj->small)){$sselected ='checked="checked"';}
		  else{$sselected='';}
	    echo '<div class="srv-off-chk"><label><input type="checkbox" name="our_expertise_data[small][]" value="'.$val.'" '.$sselected.'><span class="srv-off-title">'.$val.'</span></label></div>'; 
      }?>
	</div>
</div>
...
<div class="Expertise_Data" id="horse_supplier">
    ...
    <?php foreach($horses_supplies_arr as $val){
		if(in_array($val,$ourDataObj->horse)){$hselected ='checked="checked"';}
		  else{$hselected='';}
	    echo '<div class="srv-off-chk"><label><input type="checkbox" name="our_expertise_data[horse][]" value="'.$val.'" '.$hselected.'><span class="srv-off-title">'.$val.'</span></label></div>'; 
      }?>
	</div>
</div>
...
<div class="Expertise_Data" id="other_supplier">
    ...
    <?php foreach($other_supplies_arr as $val){
		if(in_array($val,$ourDataObj->other)){$oselected ='selected="selected"';}
		  else{$oselected='';}
	    echo '<div class="srv-off-chk"><label><input type="checkbox" name="our_expertise_data[other][]" value="'.$val.'" '.$oselected.'><span class="srv-off-title">'.$val.'</span></label></div>'; 
      }?>
	</div>
</div>
...
<label class="nrd-loginModal-label u-vr2x" for="Accepted"><span>Payments (Card Accepted)</span></label>
 <div class="payment-options">
	<label class="radio-inline">
	  <span>Yes</span> <input type="radio" name="card_accepted" id="payments1" value="Yes" <?php if($results->payments=='Yes') { echo 'checked="checked"';}?>>
	</label>
	<label class="radio-inline">
	  <span>No</span> <input type="radio" name="card_accepted" id="payments2" value="No" <?php if($results->payments=='No') { echo 'checked="checked"';}?>>
	</label>
 </div>
</li>
