...
<li>
	<label class="nrd-loginModal-label u-vr2x" for="username"><span>Regular Pet Monitoring </span></label>
	<div class="payment-options ">
		<label class="radio-inline">
			<span>Yes</span>  <input type="radio" name="pet_monitoring" value="Yes" <?php if ($results->pet_monitoring== 'Yes'){ echo $checked ='checked="checked"';} ?>> 
		</label>
		
		<label class="radio-inline">
			<span>No</span>  <input type="radio" name="pet_monitoring"  value="No" <?php if ($results->pet_monitoring == 'No'){ echo $checked ='checked="checked"'; }  ?>> 
		</label>
	</div>
</li>
<li>
