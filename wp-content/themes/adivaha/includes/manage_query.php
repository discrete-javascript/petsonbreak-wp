...
<h5 class="recent_bookings">Enquiry </h5>
...
<?php 
$resultss =$wpdb->get_results("select * from twc_queries where member_id='".$_SESSION['userID']."'");
if(count($resultss)){
 foreach($resultss as $results){ 
  $vMata=get_user_meta($results->vendor_id);
  $vendor_name =$vMata['nickname'][0];
  $product_name =$vMata['establishment'][0];
