...
<li>
<label class="nrd-loginModal-label u-vr2x" for="Accepted"><span>Membership</span></label>
 <div class="payment-options">
	<label class="radio-inline">
	  <span>IPATA</span> <input type="radio" class="certified" name="membership" value="IPATA" <?php if($results->membership=='IPATA') { echo 'checked="checked"';}?>>
	</label>
	<label class="radio-inline">
	  <span>IATA </span> <input type="radio" class="certified" name="membership" value="IATA" <?php if($results->membership=='IATA') { echo 'checked="checked"';}?>>
	</label>
 </div>
</li>
...
<label class="nrd-loginModal-label u-vr2x" for="username"><span>Payment Terms</span></label>
 <div class="payment-options">
     <label class="radio-inline">
  <span>In Advance</span> <input name="payment_terms" id="payment_terms_0" value="In Advance" type="radio" <?php if($results->payment_terms=='In Advance') { echo 'checked="checked"';}?>>
  </label>

     <label class="radio-inline">
  <span>COD</span> <input name="payment_terms" id="payment_terms_1" value="COD" type="radio" <?php if($results->payment_terms=='COD') { echo 'checked="checked"';}?>>
  </label>
