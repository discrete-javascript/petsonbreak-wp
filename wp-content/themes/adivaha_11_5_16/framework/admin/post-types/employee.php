...
function register_employees_post_type(){
	...
	register_post_type('employees', array(
		'labels' => array(
			'name' => __('Employees','mk_framework'), __('post type general name','mk_framework'),
			'singular_name' => __('Team Member','mk_framework'), __('post type singular name','mk_framework'),
			'add_new' => __('Add New Member','mk_framework'), __('employees','mk_framework'),
