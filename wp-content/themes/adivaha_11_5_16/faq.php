...
.ans_div p{    font-size: 13px;
    line-height: 25px;}
.faq-tab.isActive{    background:#663366;
    color: #fff;
    -moz-box-shadow: inset 0 0 10px #2b132b;
    -webkit-box-shadow: inset 0 0 10px #2b132b;
    box-shadow: inset 0 0 10px #2b132b;}
		...
		<div class="col-md-10 faq-main col-md-offset-1">
		   <div id="petBrd-page-wrap">
				<ul class="pet_breadcrumb">
					...
					<li class="pet_breadcrumbStep"><a href="#">FAQ's</a></li>
				</ul>
