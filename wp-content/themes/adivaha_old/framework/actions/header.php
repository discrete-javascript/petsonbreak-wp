...
if ( !function_exists( 'mk_header_social' ) ) {
	function mk_header_social($section) {
		...
		case 'rounded' :
			$icon_style = 'twc-theme-icon-square-';
			break;
		case 'simple' :
			$icon_style = 'twc-theme-icon-simple-';
			break;
		case 'circle' :
			$icon_style = 'twc-theme-icon-';
			break;
		case 'simple-rounded' :
			$icon_style = 'twc-theme-icon-simple-';
...
if ( !function_exists( 'mk_header_logo' ) ) {
	function mk_header_logo() {
		...
		<div class="header-logo">
		    <a href="<?php echo home_url( '/' ); ?>" title="<?php bloginfo( 'name' ); ?>"><img alt="<?php bloginfo( 'name' ); ?>" src="<?php echo THEME_IMAGES; ?>/twc-logo.png" /></a>
		</div>
		<?php }
