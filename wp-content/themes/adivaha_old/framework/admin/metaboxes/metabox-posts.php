...
$options = array(
      array(
            "name" => __("Choose Header", "mk_framework"),
            "desc" => __("Please choose this page's header.", "mk_framework"),
            "id" => "my_header",
            "default" => 'header2',
            "options" => array(
                  "header1" => __("Transparent Header", "mk_framework"),
                  "header2" => __("Fixed Header", "mk_framework"),
            ),
            "type" => "select"
      ),array(
            "name" => __("Layout", "mk_framework"),
            "desc" => __("Please choose the location of Sidebar in Page.", "mk_framework"),
            "id" => "my_layout",
            "default" => 'right',
            "options" => array(
