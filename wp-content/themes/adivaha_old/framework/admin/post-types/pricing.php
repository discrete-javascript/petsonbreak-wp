...
function register_pricing_post_type(){
	...
	global $mk_options;
   		if($mk_options['pricing-post-type'] == 'false') return false;


	register_post_type('pricing', array(
		'labels' => array(
			'name' => __('Pricing Tables','mk_framework'), __('post type general name','mk_framework'),
			'singular_name' => __('Pricing Item','mk_framework'), __('post type singular name','mk_framework'),
			'add_new' => __('Add New Pricing Item','mk_framework'), __('pricing','mk_framework'),
			...
			'not_found_in_trash' => __('No Pricing Item found in Trash','mk_framework', 'revisions'),
			'parent_item_colon' => '',
