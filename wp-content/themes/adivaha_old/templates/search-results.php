          ...
          <div class="row-not-use">
			...
			<div ng-if="hotelList.isFavourate==''" class="heart_icons chfavourate" data-rel="favourate" data-hotel="{{hotelList.hotelId}}" ng-click="makeFavourate( $event,hotelList.hotelId )" id="favourate_{{hotelList.hotelId}}">
			  ...
			  <span class="tooltiptext" ><?php echo $_SESSION['TXTDATA']['add_to_favourites'];?></span>
                    ...
                    <div class=" hotel-image wleft"> <a href="{{SiteUrl}}/#/hotel-information/{{ hotelList.hotelId }}/?fn=hotelInfo&checkIn={{checkInUrl}}&checkOut={{checkOutUrl}}&language={{Cri_language}}&currency={{currency}}&hotelType=1&rooms={{rooms}}&adults={{adults}}&childs={{childs}}&childAge={{childAge}}" target="_blank"><img ng-src="http://images.trvl-media.com{{ hotelList.thumbNailUrl.replace('_t', '_b') }}" alt=""></a>
                    ...
                    <div class=" bg_white hotel-detail wleft">
                      <div class="hotel-detail-colms">
                        <div class="hotl_col_left col-md-12">
                          <p class="h_name_or"><a href="{{SiteUrl}}/#/hotel-information/{{ hotelList.hotelId }}/?fn=hotelInfo&checkIn={{checkInUrl}}&checkOut={{checkOutUrl}}&language={{Cri_language}}&currency={{currency}}&hotelType=1&rooms={{rooms}}&adults={{adults}}&childs={{childs}}&childAge={{childAge}}" target="_blank"><span ng-bind-html="hotelList.name"></span></a>
						  <!--
						  <br>
